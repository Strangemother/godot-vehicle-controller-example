...
func process_keyboard(_delta):  # deprecated, use actions
	if keyboard_enabled:
...
func process_joystick(_delta):  # deprecated, use actions
	if joystick_enabled:
...
func process_zoom_inertia(_delta):
